    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-4 grid-flow-row mt-2 my-4">
            ...
            <c:forEach items="${offices}" var="office">
                ...
                >
                    <div><a href="./office-list?searchTerms=${requestScope.searchTerms}&officeCode=${office.officeCode}" class="underline">${office.city}</a>, ${office.country}</div>
